...
import lakefs_sdk_async.models
from lakefs_sdk_async import rest
from lakefs_sdk_async.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'lakefs-python-sdk/1.39.1-test'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lakefs_sdk_async.models, klass)
