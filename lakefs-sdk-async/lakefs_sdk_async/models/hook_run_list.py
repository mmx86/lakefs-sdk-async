...
class HookRunList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HookRunList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HookRunList:
        """Create an instance of HookRunList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HookRunList.parse_obj(obj)

        _obj = HookRunList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [HookRun.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
