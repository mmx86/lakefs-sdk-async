...
class CommitList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommitList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommitList:
        """Create an instance of CommitList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommitList.parse_obj(obj)

        _obj = CommitList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [Commit.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
