...
class DiffList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiffList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiffList:
        """Create an instance of DiffList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiffList.parse_obj(obj)

        _obj = DiffList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [Diff.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
