...
class RefList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RefList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RefList:
        """Create an instance of RefList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RefList.parse_obj(obj)

        _obj = RefList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [Ref.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
