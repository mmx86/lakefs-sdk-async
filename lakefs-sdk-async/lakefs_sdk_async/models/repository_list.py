...
class RepositoryList(BaseModel):
    ...
    results: conlist(Repository) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepositoryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepositoryList:
        """Create an instance of RepositoryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepositoryList.parse_obj(obj)

        _obj = RepositoryList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [Repository.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
