...
class CredentialsList(BaseModel):
    ...
    results: conlist(Credentials) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CredentialsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CredentialsList:
        """Create an instance of CredentialsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CredentialsList.parse_obj(obj)

        _obj = CredentialsList.parse_obj({
            "pagination": Pagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [Credentials.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
