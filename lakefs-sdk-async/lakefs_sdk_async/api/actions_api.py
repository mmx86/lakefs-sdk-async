...
class ActionsApi(object):
    ...
    @overload
    async def get_run(self, repository : StrictStr, run_id : StrictStr, **kwargs) -> ActionRun:  # noqa: E501
        ...

    @overload
    def get_run(self, repository : StrictStr, run_id : StrictStr, async_req: Optional[bool]=True, **kwargs) -> ActionRun:  # noqa: E501
        ...

    @validate_arguments
    def get_run(self, repository : StrictStr, run_id : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[ActionRun, Awaitable[ActionRun]]:  # noqa: E501
        """get a run  # noqa: E501
    ...
    @overload
    async def get_run_hook_output(self, repository : StrictStr, run_id : StrictStr, hook_run_id : StrictStr, **kwargs) -> bytearray:  # noqa: E501
        ...

    @overload
    def get_run_hook_output(self, repository : StrictStr, run_id : StrictStr, hook_run_id : StrictStr, async_req: Optional[bool]=True, **kwargs) -> bytearray:  # noqa: E501
        ...

    @validate_arguments
    def get_run_hook_output(self, repository : StrictStr, run_id : StrictStr, hook_run_id : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[bytearray, Awaitable[bytearray]]:  # noqa: E501
    ...
    @overload
    async def list_run_hooks(self, repository : StrictStr, run_id : StrictStr, after : Annotated[Optional[StrictStr], Field(description="return items after this value")] = None, amount : Annotated[Optional[conint(strict=True, le=1000, ge=-1)], Field(description="how many items to return")] = None, **kwargs) -> HookRunList:  # noqa: E501
        ...

    @overload
    def list_run_hooks(self, repository : StrictStr, run_id : StrictStr, after : Annotated[Optional[StrictStr], Field(description="return items after this value")] = None, amount : Annotated[Optional[conint(strict=True, le=1000, ge=-1)], Field(description="how many items to return")] = None, async_req: Optional[bool]=True, **kwargs) -> HookRunList:  # noqa: E501
        ...

    @validate_arguments
    def list_run_hooks(self, repository : StrictStr, run_id : StrictStr, after : Annotated[Optional[StrictStr], Field(description="return items after this value")] = None, amount : Annotated[Optional[conint(strict=True, le=1000, ge=-1)], Field(description="how many items to return")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[HookRunList, Awaitable[HookRunList]]:  # noqa: E501
