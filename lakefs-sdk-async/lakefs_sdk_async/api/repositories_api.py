...
class RepositoriesApi(object):
    ...
    @overload
    async def delete_repository(self, repository : StrictStr, **kwargs) -> None:  # noqa: E501
        ...

    @overload
    def delete_repository(self, repository : StrictStr, async_req: Optional[bool]=True, **kwargs) -> None:  # noqa: E501
        ...

    @validate_arguments
    def delete_repository(self, repository : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[None, Awaitable[None]]:  # noqa: E501
    ...
    @overload
    async def restore_submit(self, repository : StrictStr, refs_dump : RefsDump, **kwargs) -> TaskInfo:  # noqa: E501
        ...

    @overload
    def restore_submit(self, repository : StrictStr, refs_dump : RefsDump, async_req: Optional[bool]=True, **kwargs) -> TaskInfo:  # noqa: E501
        ...

    @validate_arguments
    def restore_submit(self, repository : StrictStr, refs_dump : RefsDump, async_req: Optional[bool]=None, **kwargs) -> Union[TaskInfo, Awaitable[TaskInfo]]:  # noqa: E501
