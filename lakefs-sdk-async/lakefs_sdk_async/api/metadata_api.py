...
class MetadataApi(object):
    ...
    @overload
    async def get_meta_range(self, repository : StrictStr, meta_range : StrictStr, **kwargs) -> StorageURI:  # noqa: E501
        ...

    @overload
    def get_meta_range(self, repository : StrictStr, meta_range : StrictStr, async_req: Optional[bool]=True, **kwargs) -> StorageURI:  # noqa: E501
        ...

    @validate_arguments
    def get_meta_range(self, repository : StrictStr, meta_range : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[StorageURI, Awaitable[StorageURI]]:  # noqa: E501
    ...
    @overload
    async def get_range(self, repository : StrictStr, range : StrictStr, **kwargs) -> StorageURI:  # noqa: E501
        ...

    @overload
    def get_range(self, repository : StrictStr, range : StrictStr, async_req: Optional[bool]=True, **kwargs) -> StorageURI:  # noqa: E501
        ...

    @validate_arguments
    def get_range(self, repository : StrictStr, range : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[StorageURI, Awaitable[StorageURI]]:  # noqa: E501
