...
class CommitsApi(object):
    ...
    @overload
    async def commit(self, repository : StrictStr, branch : StrictStr, commit_creation : CommitCreation, source_metarange : Annotated[Optional[StrictStr], Field(description="The source metarange to commit. Branch must not have uncommitted changes.")] = None, **kwargs) -> Commit:  # noqa: E501
        ...

    @overload
    def commit(self, repository : StrictStr, branch : StrictStr, commit_creation : CommitCreation, source_metarange : Annotated[Optional[StrictStr], Field(description="The source metarange to commit. Branch must not have uncommitted changes.")] = None, async_req: Optional[bool]=True, **kwargs) -> Commit:  # noqa: E501
        ...

    @validate_arguments
    def commit(self, repository : StrictStr, branch : StrictStr, commit_creation : CommitCreation, source_metarange : Annotated[Optional[StrictStr], Field(description="The source metarange to commit. Branch must not have uncommitted changes.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[Commit, Awaitable[Commit]]:  # noqa: E501
    ...
    @overload
    async def get_commit(self, repository : StrictStr, commit_id : StrictStr, **kwargs) -> Commit:  # noqa: E501
        ...

    @overload
    def get_commit(self, repository : StrictStr, commit_id : StrictStr, async_req: Optional[bool]=True, **kwargs) -> Commit:  # noqa: E501
        ...

    @validate_arguments
    def get_commit(self, repository : StrictStr, commit_id : StrictStr, async_req: Optional[bool]=None, **kwargs) -> Union[Commit, Awaitable[Commit]]:  # noqa: E501
