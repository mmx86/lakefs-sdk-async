...
class HealthCheckApi(object):
    ...
    @overload
    async def health_check(self, **kwargs) -> None:  # noqa: E501
        ...

    @overload
    def health_check(self, async_req: Optional[bool]=True, **kwargs) -> None:  # noqa: E501
        ...

    @validate_arguments
    def health_check(self, async_req: Optional[bool]=None, **kwargs) -> Union[None, Awaitable[None]]:  # noqa: E501
