...
class ExperimentalApi(object):
    ...
    @overload
    async def get_otf_diffs(self, **kwargs) -> OTFDiffs:  # noqa: E501
        ...

    @overload
    def get_otf_diffs(self, async_req: Optional[bool]=True, **kwargs) -> OTFDiffs:  # noqa: E501
        ...

    @validate_arguments
    def get_otf_diffs(self, async_req: Optional[bool]=None, **kwargs) -> Union[OTFDiffs, Awaitable[OTFDiffs]]:  # noqa: E501
    ...
    @overload
    async def otf_diff(self, repository : StrictStr, left_ref : StrictStr, right_ref : StrictStr, table_path : Annotated[StrictStr, Field(..., description="a path to the table location under the specified ref.")], type : Annotated[StrictStr, Field(..., description="the type of otf")], **kwargs) -> OtfDiffList:  # noqa: E501
        ...

    @overload
    def otf_diff(self, repository : StrictStr, left_ref : StrictStr, right_ref : StrictStr, table_path : Annotated[StrictStr, Field(..., description="a path to the table location under the specified ref.")], type : Annotated[StrictStr, Field(..., description="the type of otf")], async_req: Optional[bool]=True, **kwargs) -> OtfDiffList:  # noqa: E501
        ...

    @validate_arguments
    def otf_diff(self, repository : StrictStr, left_ref : StrictStr, right_ref : StrictStr, table_path : Annotated[StrictStr, Field(..., description="a path to the table location under the specified ref.")], type : Annotated[StrictStr, Field(..., description="the type of otf")], async_req: Optional[bool]=None, **kwargs) -> Union[OtfDiffList, Awaitable[OtfDiffList]]:  # noqa: E501
