...
class StagingApi(object):
    ...
    @overload
    def link_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], staging_metadata : StagingMetadata, if_none_match : Annotated[Optional[StrictStr], Field(description="Set to \"*\" to atomically allow the upload only if the key has no object yet. Other values are not supported.")] = None, async_req: Optional[bool]=True, **kwargs) -> ObjectStats:  # noqa: E501
        ...

    @validate_arguments
    def link_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], staging_metadata : StagingMetadata, if_none_match : Annotated[Optional[StrictStr], Field(description="Set to \"*\" to atomically allow the upload only if the key has no object yet. Other values are not supported.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ObjectStats, Awaitable[ObjectStats]]:  # noqa: E501
