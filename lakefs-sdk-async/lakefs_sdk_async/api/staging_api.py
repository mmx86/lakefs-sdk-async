...
class StagingApi(object):
    ...
    @overload
    async def get_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], presign : Optional[StrictBool] = None, **kwargs) -> StagingLocation:  # noqa: E501
        ...

    @overload
    def get_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], presign : Optional[StrictBool] = None, async_req: Optional[bool]=True, **kwargs) -> StagingLocation:  # noqa: E501
        ...

    @validate_arguments
    def get_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], presign : Optional[StrictBool] = None, async_req: Optional[bool]=None, **kwargs) -> Union[StagingLocation, Awaitable[StagingLocation]]:  # noqa: E501
    ...
    @overload
    async def link_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], staging_metadata : StagingMetadata, **kwargs) -> ObjectStats:  # noqa: E501
        ...

    @overload
    def link_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], staging_metadata : StagingMetadata, async_req: Optional[bool]=True, **kwargs) -> ObjectStats:  # noqa: E501
        ...

    @validate_arguments
    def link_physical_address(self, repository : StrictStr, branch : StrictStr, path : Annotated[StrictStr, Field(..., description="relative to the branch")], staging_metadata : StagingMetadata, async_req: Optional[bool]=None, **kwargs) -> Union[ObjectStats, Awaitable[ObjectStats]]:  # noqa: E501
