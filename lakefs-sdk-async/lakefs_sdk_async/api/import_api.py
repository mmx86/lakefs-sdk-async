...
class ImportApi(object):
    ...
    @overload
    async def import_cancel(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], **kwargs) -> None:  # noqa: E501
        ...

    @overload
    def import_cancel(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], async_req: Optional[bool]=True, **kwargs) -> None:  # noqa: E501
        ...

    @validate_arguments
    def import_cancel(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], async_req: Optional[bool]=None, **kwargs) -> Union[None, Awaitable[None]]:  # noqa: E501
    ...
    @overload
    async def import_start(self, repository : StrictStr, branch : StrictStr, import_creation : ImportCreation, **kwargs) -> ImportCreationResponse:  # noqa: E501
        ...

    @overload
    def import_start(self, repository : StrictStr, branch : StrictStr, import_creation : ImportCreation, async_req: Optional[bool]=True, **kwargs) -> ImportCreationResponse:  # noqa: E501
        ...

    @validate_arguments
    def import_start(self, repository : StrictStr, branch : StrictStr, import_creation : ImportCreation, async_req: Optional[bool]=None, **kwargs) -> Union[ImportCreationResponse, Awaitable[ImportCreationResponse]]:  # noqa: E501
    ...
    @overload
    async def import_status(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], **kwargs) -> ImportStatus:  # noqa: E501
        ...

    @overload
    def import_status(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], async_req: Optional[bool]=True, **kwargs) -> ImportStatus:  # noqa: E501
        ...

    @validate_arguments
    def import_status(self, repository : StrictStr, branch : StrictStr, id : Annotated[StrictStr, Field(..., description="Unique identifier of the import process")], async_req: Optional[bool]=None, **kwargs) -> Union[ImportStatus, Awaitable[ImportStatus]]:  # noqa: E501
