...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    object_copy_creation = lakefs_sdk_async.ObjectCopyCreation() # ObjectCopyCreation | 

    try:
        # create a copy of an object
        api_response = await api_instance.copy_object(repository, branch, dest_path, object_copy_creation)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get object properties on underlying storage
        api_response = await api_instance.get_underlying_properties(repository, ref, path)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # check if object exists
        await api_instance.head_object(repository, ref, path, range=range)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list objects under a given prefix
        api_response = await api_instance.list_objects(repository, ref, user_metadata=user_metadata, presign=presign, after=after, amount=amount, delimiter=delimiter, prefix=prefix)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get object metadata
        api_response = await api_instance.stat_object(repository, ref, path, user_metadata=user_metadata, presign=presign)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.upload_object(repository, branch, path, storage_class=storage_class, if_none_match=if_none_match, force=force, content=content)
