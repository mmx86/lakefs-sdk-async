...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    group_id = 'group_id_example' # str | 
    user_id = 'user_id_example' # str | 

    try:
        # add group membership
        await api_instance.add_group_membership(group_id, user_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # attach policy to group
        await api_instance.attach_policy_to_group(group_id, policy_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # attach policy to user
        await api_instance.attach_policy_to_user(user_id, policy_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # create credentials
        api_response = await api_instance.create_credentials(user_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    group_creation = lakefs_sdk_async.GroupCreation() # GroupCreation |  (optional)

    try:
        # create group
        api_response = await api_instance.create_group(group_creation=group_creation)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    policy = lakefs_sdk_async.Policy() # Policy | 

    try:
        # create policy
        api_response = await api_instance.create_policy(policy)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    user_creation = lakefs_sdk_async.UserCreation() # UserCreation |  (optional)

    try:
        # create user
        api_response = await api_instance.create_user(user_creation=user_creation)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    external_principal_creation = lakefs_sdk_async.ExternalPrincipalCreation() # ExternalPrincipalCreation |  (optional)

    try:
        # attach external principal to user
        await api_instance.create_user_external_principal(user_id, principal_id, external_principal_creation=external_principal_creation)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # delete credentials
        await api_instance.delete_credentials(user_id, access_key_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # delete group
        await api_instance.delete_group(group_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # delete group membership
        await api_instance.delete_group_membership(group_id, user_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # delete policy
        await api_instance.delete_policy(policy_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # delete user
        await api_instance.delete_user(user_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # delete external principal from user
        await api_instance.delete_user_external_principal(user_id, principal_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # detach policy from group
        await api_instance.detach_policy_from_group(group_id, policy_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # detach policy from user
        await api_instance.detach_policy_from_user(user_id, policy_id)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    external_login_information = lakefs_sdk_async.ExternalLoginInformation() # ExternalLoginInformation |  (optional)

    try:
        # perform a login using an external authenticator
        api_response = await api_instance.external_principal_login(external_login_information=external_login_information)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get credentials
        api_response = await api_instance.get_credentials(user_id, access_key_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get current user
        api_response = await api_instance.get_current_user()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # describe external principal by id
        api_response = await api_instance.get_external_principal(principal_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get group
        api_response = await api_instance.get_group(group_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get ACL of group
        api_response = await api_instance.get_group_acl(group_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get policy
        api_response = await api_instance.get_policy(policy_id)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list group members
        api_response = await api_instance.list_group_members(group_id, prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list group policies
        api_response = await api_instance.list_group_policies(group_id, prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list groups
        api_response = await api_instance.list_groups(prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list policies
        api_response = await api_instance.list_policies(prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list user credentials
        api_response = await api_instance.list_user_credentials(user_id, prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list user external policies attached to a user
        api_response = await api_instance.list_user_external_principals(user_id, prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list user groups
        api_response = await api_instance.list_user_groups(user_id, prefix=prefix, after=after, amount=amount)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    after = 'after_example' # str | return items after this value (optional)
    amount = 100 # int | how many items to return (optional) (default to 100)
    effective = False # bool | will return all distinct policies attached to the user or any of its groups (optional) (default to False)

    try:
        # list user policies
        api_response = await api_instance.list_user_policies(user_id, prefix=prefix, after=after, amount=amount, effective=effective)
        print("The response of AuthApi->list_user_policies:\n")
        pprint(api_response)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list users
        api_response = await api_instance.list_users(prefix=prefix, after=after, amount=amount)
        print("The response of AuthApi->list_users:\n")
        pprint(api_response)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    login_information = lakefs_sdk_async.LoginInformation() # LoginInformation |  (optional)

    try:
        # perform a login
        api_response = await api_instance.login(login_information=login_information)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **login_information** | [**LoginInformation**](LoginInformation.md)|  | [optional] 
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.AuthApi(api_client)
    group_id = 'group_id_example' # str | 
    acl = lakefs_sdk_async.ACL() # ACL | 

    try:
        # set ACL of group
        await api_instance.set_group_acl(group_id, acl)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # update policy
        api_response = await api_instance.update_policy(policy_id, policy)
        print("The response of AuthApi->update_policy:\n")
        pprint(api_response)
    except Exception as e:
