# lakefs_sdk_async.ExperimentalApi
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.ExperimentalApi(api_client)
    repository = 'repository_example' # str | 
    branch = 'branch_example' # str | 
    upload_id = 'upload_id_example' # str | 
    path = 'path_example' # str | relative to the branch
    abort_presign_multipart_upload = lakefs_sdk_async.AbortPresignMultipartUpload() # AbortPresignMultipartUpload |  (optional)

    try:
        # Abort a presign multipart upload
        await api_instance.abort_presign_multipart_upload(repository, branch, upload_id, path, abort_presign_multipart_upload=abort_presign_multipart_upload)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    upload_id = 'upload_id_example' # str | 
    path = 'path_example' # str | relative to the branch
    complete_presign_multipart_upload = lakefs_sdk_async.CompletePresignMultipartUpload() # CompletePresignMultipartUpload |  (optional)

    try:
        # Complete a presign multipart upload request
        api_response = await api_instance.complete_presign_multipart_upload(repository, branch, upload_id, path, complete_presign_multipart_upload=complete_presign_multipart_upload)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Initiate a multipart upload
        api_response = await api_instance.create_presign_multipart_upload(repository, branch, path, parts=parts)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.ExperimentalApi(api_client)
    repository = 'repository_example' # str | 
    pull_request_creation = lakefs_sdk_async.PullRequestCreation() # PullRequestCreation | 

    try:
        # create pull request
        api_response = await api_instance.create_pull_request(repository, pull_request_creation)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get pull request
        api_response = await api_instance.get_pull_request(repository, pull_request)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # hard reset branch
        await api_instance.hard_reset_branch(repository, branch, ref, force=force)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list pull requests
        api_response = await api_instance.list_pull_requests(repository, prefix=prefix, after=after, amount=amount, status=status)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # merge pull request
        api_response = await api_instance.merge_pull_request(repository, pull_request)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.ExperimentalApi(api_client)
    sts_auth_request = lakefs_sdk_async.StsAuthRequest() # StsAuthRequest | 

    try:
        # perform a login with STS
        api_response = await api_instance.sts_login(sts_auth_request)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    repository = 'repository_example' # str | 
    pull_request = 'pull_request_example' # str | pull request id
    pull_request_basic = lakefs_sdk_async.PullRequestBasic() # PullRequestBasic | 

    try:
        # update pull request
        await api_instance.update_pull_request(repository, pull_request, pull_request_basic)
    except Exception as e:
