...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.create_branch_protection_rule_preflight(repository)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    repository = 'repository_example' # str | 
    commit_record_creation = lakefs_sdk_async.CommitRecordCreation() # CommitRecordCreation | 

    try:
        # create commit record
        await api_instance.create_commit_record(repository, commit_record_creation)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # creates symlink files corresponding to the given directory
        api_response = await api_instance.create_symlink_file(repository, branch, location=location)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    repository = 'repository_example' # str | 
    repository_metadata_keys = lakefs_sdk_async.RepositoryMetadataKeys() # RepositoryMetadataKeys | 

    try:
        # delete repository metadata
        await api_instance.delete_repository_metadata(repository, repository_metadata_keys)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Dump repository refs (tags, commits, branches) to object store Deprecated: a new API will introduce long running operations 
        api_response = await api_instance.dump_refs(repository)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list authentication capabilities supported
        api_response = await api_instance.get_auth_capabilities()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_garbage_collection_config()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_lake_fs_version()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # return a lakeFS metadata object by ID
        api_response = await api_instance.get_metadata_object(repository, object_id, type, presign=presign)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # check if the lakeFS installation is already set up
        api_response = await api_instance.get_setup_state()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_storage_config()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get usage report summary
        api_response = await api_instance.get_usage_report_summary()
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    repository = 'repository_example' # str | 
    branch_protection_rule = lakefs_sdk_async.BranchProtectionRule() # BranchProtectionRule | 

    try:
        await api_instance.internal_create_branch_protection_rule(repository, branch_protection_rule)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    repository = 'repository_example' # str | 
    internal_delete_branch_protection_rule_request = lakefs_sdk_async.InternalDeleteBranchProtectionRuleRequest() # InternalDeleteBranchProtectionRuleRequest | 

    try:
        await api_instance.internal_delete_branch_protection_rule(repository, internal_delete_branch_protection_rule_request)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.internal_delete_garbage_collection_rules(repository)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get branch protection rules
        api_response = await api_instance.internal_get_branch_protection_rules(repository)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.internal_get_garbage_collection_rules(repository)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.internal_set_garbage_collection_rules(repository, garbage_collection_rules)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    stats_events_list = lakefs_sdk_async.StatsEventsList() # StatsEventsList | 

    try:
        # post stats events, this endpoint is meant for internal use only
        await api_instance.post_stats_events(stats_events_list)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # save lists of active commits for garbage collection
        api_response = await api_instance.prepare_garbage_collection_commits(repository)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    repository = 'repository_example' # str | 
    prepare_gc_uncommitted_request = lakefs_sdk_async.PrepareGCUncommittedRequest() # PrepareGCUncommittedRequest |  (optional)

    try:
        # save repository uncommitted metadata for garbage collection
        api_response = await api_instance.prepare_garbage_collection_uncommitted(repository, prepare_gc_uncommitted_request=prepare_gc_uncommitted_request)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.set_garbage_collection_rules_preflight(repository)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    repository = 'repository_example' # str | 
    repository_metadata_set = lakefs_sdk_async.RepositoryMetadataSet() # RepositoryMetadataSet | 

    try:
        # set repository metadata
        await api_instance.set_repository_metadata(repository, repository_metadata_set)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    setup = lakefs_sdk_async.Setup() # Setup | 

    try:
        # setup lakeFS and create a first user
        api_response = await api_instance.setup(setup)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = lakefs_sdk_async.InternalApi(api_client)
    comm_prefs_input = lakefs_sdk_async.CommPrefsInput() # CommPrefsInput | 

    try:
        # setup communications preferences
        await api_instance.setup_comm_prefs(comm_prefs_input)
    except Exception as e:
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    object_stage_creation = lakefs_sdk_async.ObjectStageCreation() # ObjectStageCreation | 

    try:
        # stage an object's metadata for the given branch
        api_response = await api_instance.stage_object(repository, branch, path, object_stage_creation)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.upload_object_preflight(repository, branch, path)
    except Exception as e:
