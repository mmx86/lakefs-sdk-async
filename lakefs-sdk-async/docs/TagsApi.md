...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    tag_creation = lakefs_sdk_async.TagCreation() # TagCreation | 

    try:
        # create tag
        api_response = await api_instance.create_tag(repository, tag_creation)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get tag
        api_response = await api_instance.get_tag(repository, tag)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # list tags
        api_response = await api_instance.list_tags(repository, prefix=prefix, after=after, amount=amount)
