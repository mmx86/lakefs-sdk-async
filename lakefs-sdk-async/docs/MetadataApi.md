...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.MetadataApi(api_client)
    repository = 'repository_example' # str | 
    meta_range = 'meta_range_example' # str | 

    try:
        # return URI to a meta-range file
        api_response = await api_instance.get_meta_range(repository, meta_range)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # return URI to a range file
        api_response = await api_instance.get_range(repository, range)
