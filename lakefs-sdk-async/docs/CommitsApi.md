...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    api_instance = lakefs_sdk_async.CommitsApi(api_client)
    repository = 'repository_example' # str | 
    branch = 'branch_example' # str | 
    commit_creation = lakefs_sdk_async.CommitCreation() # CommitCreation | 
    ...
    try:
        # create commit
        api_response = await api_instance.commit(repository, branch, commit_creation, source_metarange=source_metarange)
...
async with lakefs_sdk_async.ApiClient(configuration) as api_client:
    ...
    try:
        # get commit
        api_response = await api_instance.get_commit(repository, commit_id)
