...
from lakefs_sdk_async.models.repository_list import RepositoryList  # noqa: E501
...
class TestRepositoryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.repository_list.RepositoryList()  # noqa: E501
        if include_optional :
            return RepositoryList(
                pagination = lakefs_sdk_async.models.pagination.Pagination(
                    ...
                    max_per_page = 0, ), 
                results = [
                    lakefs_sdk_async.models.repository.Repository(
                        id = '', 
                        creation_date = 56, 
                        default_branch = '', 
                        storage_namespace = '', )
