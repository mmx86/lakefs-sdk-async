...
from lakefs_sdk_async.models.current_user import CurrentUser  # noqa: E501
...
class TestCurrentUser(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.current_user.CurrentUser()  # noqa: E501
        if include_optional :
            return CurrentUser(
                user = lakefs_sdk_async.models.user.User(
                    id = '', 
                    creation_date = 56, 
                    friendly_name = '', 
                    email = '', )
