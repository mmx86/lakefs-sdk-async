...
from lakefs_sdk_async.models.complete_presign_multipart_upload import CompletePresignMultipartUpload  # noqa: E501
...
class TestCompletePresignMultipartUpload(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.complete_presign_multipart_upload.CompletePresignMultipartUpload()  # noqa: E501
        if include_optional :
            return CompletePresignMultipartUpload(
                physical_address = '', 
                parts = [
                    lakefs_sdk_async.models.upload_part.UploadPart(
                        part_number = 56, 
                        etag = '', )
                    ], 
                user_metadata = {
