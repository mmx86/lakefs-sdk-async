...
from lakefs_sdk_async.models.user_list import UserList  # noqa: E501
...
class TestUserList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.user_list.UserList()  # noqa: E501
        if include_optional :
            return UserList(
                pagination = lakefs_sdk_async.models.pagination.Pagination(
                    ...
                    max_per_page = 0, ), 
                results = [
                    lakefs_sdk_async.models.user.User(
                        id = '', 
                        creation_date = 56, 
                        friendly_name = '', 
                        email = '', )
