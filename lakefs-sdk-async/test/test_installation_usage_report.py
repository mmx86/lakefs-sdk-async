...
from lakefs_sdk_async.models.installation_usage_report import InstallationUsageReport  # noqa: E501
...
class TestInstallationUsageReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.installation_usage_report.InstallationUsageReport()  # noqa: E501
        if include_optional :
            return InstallationUsageReport(
                installation_id = '', 
                reports = [
                    lakefs_sdk_async.models.usage_report.UsageReport(
                        year = 56, 
                        month = 56, 
                        count = 56, )
                    ]
