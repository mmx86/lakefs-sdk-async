...
from lakefs_sdk_async.models.hook_run_list import HookRunList  # noqa: E501
...
class TestHookRunList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.hook_run_list.HookRunList()  # noqa: E501
        if include_optional :
            return HookRunList(
                pagination = lakefs_sdk_async.models.pagination.Pagination(
                    ...
                    max_per_page = 0, ), 
                results = [
                    lakefs_sdk_async.models.hook_run.HookRun(
                        hook_run_id = '', 
                        action = '', 
                        hook_id = '', 
