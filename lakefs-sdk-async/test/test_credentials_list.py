...
from lakefs_sdk_async.models.credentials_list import CredentialsList  # noqa: E501
...
class TestCredentialsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.credentials_list.CredentialsList()  # noqa: E501
        if include_optional :
            return CredentialsList(
                pagination = lakefs_sdk_async.models.pagination.Pagination(
                    ...
                    max_per_page = 0, ), 
                results = [
                    lakefs_sdk_async.models.credentials.Credentials(
                        access_key_id = '', 
                        creation_date = 56, )
                    ]
            )
