...
from lakefs_sdk_async.models.stats_events_list import StatsEventsList  # noqa: E501
...
class TestStatsEventsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.stats_events_list.StatsEventsList()  # noqa: E501
        if include_optional :
            return StatsEventsList(
                events = [
                    lakefs_sdk_async.models.stats_event.StatsEvent(
                        class = '', 
                        name = '', 
                        count = 56, )
                    ]
