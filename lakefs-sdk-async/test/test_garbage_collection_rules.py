...
from lakefs_sdk_async.models.garbage_collection_rules import GarbageCollectionRules  # noqa: E501
...
class TestGarbageCollectionRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.garbage_collection_rules.GarbageCollectionRules()  # noqa: E501
        if include_optional :
            return GarbageCollectionRules(
                default_retention_days = 56, 
                branches = [
                    lakefs_sdk_async.models.garbage_collection_rule.GarbageCollectionRule(
                        branch_id = '', 
                        retention_days = 56, )
                    ]
            )
