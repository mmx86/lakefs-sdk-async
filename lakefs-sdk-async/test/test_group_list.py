...
from lakefs_sdk_async.models.group_list import GroupList  # noqa: E501
...
class TestGroupList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.group_list.GroupList()  # noqa: E501
        if include_optional :
            return GroupList(
                pagination = lakefs_sdk_async.models.pagination.Pagination(
                    ...
                    max_per_page = 0, ), 
                results = [
                    lakefs_sdk_async.models.group.Group(
                        id = '', 
                        creation_date = 56, )
                    ]
            )
