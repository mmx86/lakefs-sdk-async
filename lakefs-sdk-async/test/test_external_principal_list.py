...
from lakefs_sdk_async.models.external_principal_list import ExternalPrincipalList  # noqa: E501
...
class TestExternalPrincipalList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = lakefs_sdk_async.models.external_principal_list.ExternalPrincipalList()  # noqa: E501
        if include_optional :
            return ExternalPrincipalList(
                pagination = lakefs_sdk_async.models.pagination.Pagination(
                    ...
                    max_per_page = 0, ), 
                results = [
                    lakefs_sdk_async.models.external_principal.ExternalPrincipal(
                        id = '', 
                        user_id = '', 
                        settings = [
                            {
